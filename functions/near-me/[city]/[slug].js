...
function renderPremiumPage(l, allMedia, reviews) {
  ...
  if (l.website) socialsHTML += `<a href="${esc(l.website)}" target="_blank" rel="noopener" class="social-pill">\uD83C\uDF10 ${esc((l.website || '').replace(/https?:\/\//, ''))}</a>`;
  if (l.tiktok) socialsHTML += `<a href="https://tiktok.com/@${esc(l.tiktok)}" target="_blank" rel="noopener" class="social-pill">\u266A @${esc(l.tiktok)}</a>`;
  if (l.facebook) socialsHTML += `<a href="https://facebook.com/${esc(l.facebook)}" target="_blank" rel="noopener" class="social-pill">f ${esc(l.facebook)}</a>`;
  ...
  <nav class="hero-nav">
    <div class="hero-nav-inner">
      ...
      <div class="nav-r">
        ...
        <a href="/for-professionals">For Pros</a>
      </div>
    </div>
  </nav>
</div>
