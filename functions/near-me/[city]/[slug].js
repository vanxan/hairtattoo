...
function affUrl(url){if(!url)return url;var u=new URL(url);if(u.hostname.includes('amazon.com')&&!u.searchParams.has('tag'))u.searchParams.set('tag','hairtattoo-20');return u.toString();}
...
function openProduct(idx){
  ...
  if(p.affiliate_url){
    h+='<a class="sp-amazon" href="'+affUrl(p.affiliate_url)+'" target="_blank" rel="noopener" onclick="event.stopPropagation()">\\u{1F6D2} Buy on Amazon</a>';
  }else{
